...
const postToFanpage = (content) => {
    ...
    var message = {
        "message" : `M2M-FxSignals \n We've just closing a winning signal with profit of ${content.profit} pips. \n Currency: ${content.currency} * Open: ${content.open} \n * Take Profit: ${content.tp3} \n * Analyzed Evidence: ${content.evidence_link} \n \n For more signal details, download from: ${content.app_link}`
    }
